...
# Configuration
PIPELINE_SCRIPT = "V12_unified_pipeline.py"
PREDICTIONS_CSV = "today_predictions.csv"
...
def generate_html(data):
    """Generate the HTML page for today's picks."""
    central = pytz.timezone('America/Chicago')
    now = datetime.now(central)
...
<head>
    ...
    <title>Free CBB Picks Today - {date_str} | SmartBetCalcs</title>
    <meta name="description" content="Free college basketball picks for {date_str}. Algorithm-driven CBB predictions with confidence ratings and expected value analysis.">
    ...
    <style>
        ...
        .page-header {{
            ...
            margin-bottom: 2rem;
            padding: 2rem;
            background: linear-gradient(135deg, var(--primary-rose), #f97316);
            border-radius: 12px;
            color: white;
        }}
        .page-header h1 {{
...
<body>
    ...
    <nav class="nav-section">
        <div class="nav-buttons">
            ...
            <a href="/free-cbb-picks.html" class="nav-btn cbb-highlight">Free CBB Picks</a>
    ...
    <div class="picks-container">
        ...
        {"<div class='picks-grid'>" + pick_cards + "</div>" if data["total_games"] > 0 else "<div class='no-picks'><h2>No Games Today</h2><p>Check back tomorrow for more college basketball picks.</p></div>"}
